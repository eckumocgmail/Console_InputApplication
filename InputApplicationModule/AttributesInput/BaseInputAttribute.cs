...
public abstract class BaseInputAttribute : DataTypeAttribute, MyValidation
{
    ...
    public abstract string OnValidate(object model, string property, object value);
    public abstract string OnGetMessage(object model, string property, object value);
